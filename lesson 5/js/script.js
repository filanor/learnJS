...
let startButton = document.getElementById('start'),
    ...
    timeyearValue = document.querySelector('.time-data .year-value'),
    timeMonthValue = document.querySelector('.time-data .month-value'),
    timeDayValue = document.querySelector('.time-data .day-value');